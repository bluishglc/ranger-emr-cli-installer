...
Invoke-WebRequest -Uri "https://raw.githubusercontent.com/bluishglc/ranger-emr-cli-installer/master/conf/ad/kerberos-encrytion-types.reg" -OutFile "C:\kerberos-encrytion-types.reg"

workflow Install-AD {
    InlineScript {
        # config "encrypt types for Kerberos" on AD
#        $WebClient = New-Object System.Net.WebClient
#        $WebClient.DownloadFile("https://raw.githubusercontent.com/bluishglc/ranger-emr-cli-installer/master/conf/ad/kerberos-encrytion-types.reg","C:\kerberos-encrytion-types.reg")

        reg import "C:\kerberos-encrytion-types.reg"
